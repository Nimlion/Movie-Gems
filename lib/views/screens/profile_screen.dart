...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _pushLoginScreen() {
    ...
    Navigator.pop(context);
    Navigator.push(context, PageRoutes.sharedAxis(() => LoginScreen()));
  }
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
            ...
            onSubmitted: (value) => FirebaseAuthentication().updateEmail(value),
        ...
        RaisedButton(
          ...
          onPressed: () => FirebaseAuthentication().updateEmail(_email),
        ),
      ],
    );
  }
